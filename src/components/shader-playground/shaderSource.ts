...
void main() {
  ...
  // Light source position (mix between fixed and mouse)
  ...
  // === Cloud Layer 3: Fine wispy detail ===
  vec3 noisePos3 = vec3(
  ...
  // Cloud thickness for iridescence
  ...
  // Fresnel shift: warm near light, cool away
  ...
  vec3 finalColor = mix(bgColor, color, cloudShape);
