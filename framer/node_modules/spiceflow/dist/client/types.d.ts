...
export declare namespace SpiceflowClient {
    ...
    } ? Prettify<Sign<Schema>> : 'Install latest Spiceflow before using the client, make sure both client and server use the same version. Make sure you passed the App type generic if using createSpiceflowClient';
