...
var VideoMemo = /* @__PURE__ */ memo(function VideoInner(props) {
  ...
  return /* @__PURE__ */ _jsx("video", { onClick, onMouseEnter, onMouseLeave, onMouseDown, onMouseUp, src, loop, ref: videoRef, onSeeked: (e) => {
  ...
  }, autoPlay: autoplayBehavior === "on-mount", poster: posterEnabled ? poster : void 0, onLoadedData: handleReady, controls, muted: isOnCanvas ? true : muted, playsInline: playsinline, style: { cursor: !!onClick ? "pointer" : "auto", width: "100%", height: "100%", borderRadius, display: "block", objectFit, backgroundColor, objectPosition: "50% 50%" } });
});
Video.displayName = "Video";
Video.defaultProps = { srcType: SrcType.Url, srcUrl: "https://assets.mixkit.co/videos/preview/mixkit-ice-cream-glass-of-red-soda-5094-small.mp4", srcFile: "", posterEnabled: false, controls: false, playing: true, loop: true, muted: true, playsinline: true, restartOnEnter: false, objectFit: ObjectFitType.Cover, backgroundColor: "rgba(0,0,0,0)", radius: 0, volume: 25, startTime: 0 };
...
var objectFitOptions = [ObjectFitType.Cover, ObjectFitType.Fill, ObjectFitType.Contain, ObjectFitType.ScaleDown, ObjectFitType.None];
addPropertyControls(Video, {
  srcType: { type: ControlType.Enum, displaySegmentedControl: true, title: "Source", options: [SrcType.Url, SrcType.Video] },
  srcUrl: { type: ControlType.String, title: " ", placeholder: "../example.mp4", hidden(props) {
    return props.srcType === SrcType.Video;
  }, description: "Hosted video file URL. For YouTube, use the YouTube component." },
  srcFile: { type: ControlType.File, title: " ", allowedFileTypes: ["mp4"], hidden(props) {
